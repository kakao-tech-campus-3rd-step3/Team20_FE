export const SIDEBAR_SEARCH_CLASSES = {
  ...
  CLEAR_BUTTON: 'absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-(--color-text-tertiary) hover:text-(--color-text-secondary)',
  CLEAR_ICON: 'w-4 h-4',
...
export const DEFAULT_AVG_RATING = 4.5;
