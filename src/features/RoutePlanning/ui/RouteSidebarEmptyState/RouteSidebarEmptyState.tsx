import { ROUTE_SIDEBAR_TITLES, ROUTE_SIDEBAR_ICONS } from '../../model/messages';

export function RouteSidebarEmptyState() {
  return (
    <div className="p-(--spacing-6) text-center">
      <div className="w-16 h-16 mx-auto mb-(--spacing-4) bg-(--color-background-secondary) rounded-full flex items-center justify-center">
