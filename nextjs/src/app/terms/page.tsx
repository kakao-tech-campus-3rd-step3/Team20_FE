...
export const metadata: Metadata = {
  title: '이용약관 - K-SPOT',
  description: 'K-SPOT 서비스 이용약관을 확인하세요.',
};
    ...
    <main className="min-h-screen bg-[var(--color-background-primary)]">
      <div className="max-w-4xl mx-auto px-[var(--spacing-4)] py-[var(--spacing-8)]">
        ...
        <header className="mb-[var(--spacing-8)] animate-slide-down">
          ...
          <div className="flex items-center gap-[var(--spacing-3)] mb-[var(--spacing-4)]">
            <div className="w-12 h-12 bg-[var(--color-brand-primary)] rounded-lg flex items-center justify-center shadow-[var(--shadow-brand-sm)]">
              <FileText className="w-6 h-6 text-[var(--color-brand-secondary)]" aria-hidden />
            </div>
            <div>
              <h1 className="text-heading-1 text-[var(--color-text-primary)]">이용약관</h1>
        ...
        <article className="prose prose-lg max-w-none animate-fade-in">
          <section className="bg-[var(--color-background-secondary)] rounded-lg p-[var(--spacing-6)] mb-[var(--spacing-8)] shadow-[var(--shadow-card)]">
            <h2 className="text-heading-4 text-[var(--color-text-primary)] mb-[var(--spacing-4)] flex items-center gap-[var(--spacing-2)]">
              <Users className="w-5 h-5 text-[var(--color-brand-secondary)]" aria-hidden />
              서비스 이용약관
            </h2>
            <p className="text-[var(--color-text-primary)] leading-relaxed text-body">
              본 약관은 K-SPOT 서비스를 이용하는 이용자와 서비스 제공자 간의 권리,
          ...
          <div className="space-y-[var(--spacing-8)]">
            <section className="animate-slide-up">
              <h2 className="text-heading-2 text-[var(--color-text-primary)] mb-[var(--spacing-4)]">
                제1조 (목적)
              </h2>
              <div className="bg-[var(--color-background-primary)] border border-[var(--color-border-primary)] rounded-lg p-[var(--spacing-6)] shadow-[var(--shadow-card)]">
                <p className="text-[var(--color-text-secondary)] leading-relaxed text-body">
            ...
            <section className="animate-slide-up">
              ...
              <div className="bg-[var(--color-background-primary)] border border-[var(--color-border-primary)] rounded-lg p-[var(--spacing-6)] shadow-[var(--shadow-card)]">
                <div className="space-y-[var(--spacing-4)] text-[var(--color-text-secondary)] text-body">
                  <div>
                    <p className="font-medium">1. 서비스란</p>
                    <p className="ml-[var(--spacing-4)]">
                      K-SPOT이 제공하는 한국 문화 콘텐츠 관련 정보 제공, 촬영지 정보, 지도 서비스
                      등을 의미합니다.
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">2. 이용자란</p>
                    <p className="ml-[var(--spacing-4)]">
                  ...
                  <div>
                    <p className="font-medium">3. 회원이란</p>
                    <p className="ml-[var(--spacing-4)]">
            ...
            <section className="animate-slide-up">
              ...
              <div className="bg-[var(--color-background-primary)] border border-[var(--color-border-primary)] rounded-lg p-[var(--spacing-6)] shadow-[var(--shadow-card)]">
                <div className="space-y-[var(--spacing-4)] text-[var(--color-text-secondary)] text-body">
                  ...
                  <ul className="ml-[var(--spacing-6)] space-y-[var(--spacing-2)]">
          ...
          {/* 연락처 섹션 */}
          <footer className="mt-[var(--spacing-12)] bg-[var(--color-brand-primary)] rounded-lg p-[var(--spacing-6)] shadow-[var(--shadow-brand-md)]">
            <h2 className="text-heading-4 text-[var(--color-text-primary)] mb-[var(--spacing-4)] flex items-center gap-[var(--spacing-2)]">
              <AlertCircle className="w-5 h-5 text-[var(--color-brand-secondary)]" aria-hidden />
              문의사항이 있으신가요?
            </h2>
            <p className="text-[var(--color-text-secondary)] mb-[var(--spacing-4)] text-body">
            ...
            <div className="flex flex-wrap gap-[var(--spacing-4)]">
              <Link
                href="/contact"
                className="inline-flex items-center gap-[var(--spacing-2)] bg-[var(--color-brand-secondary)] hover:bg-[var(--color-brand-tertiary)] text-[var(--color-text-inverse)] font-medium py-[var(--spacing-2)] px-[var(--spacing-4)] rounded-lg transition-colors duration-200 text-button shadow-[var(--shadow-button-hover)]"
              >
                고객센터 문의
              </Link>
            </div>
