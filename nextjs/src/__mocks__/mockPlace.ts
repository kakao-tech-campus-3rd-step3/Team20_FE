...
export const MOCK_PLACES: Place[] = [
  {
    ...
    locationImage: thumbnails[0].src,
    imageUrl: [thumbnails[0].src],
    latitude: 37.3234,
    longitude: 126.8321,
  ...
  },
  {
    ...
    locationImage: thumbnails[1].src,
    imageUrl: [thumbnails[1].src],
    latitude: 37.4222,
    longitude: 126.3777,
    relatedContents: [{ contentId: 5, title: '오징어게임', category: 'DRAMA' }],
  },
  {
    ...
    locationImage: thumbnails[2].src,
    imageUrl: [thumbnails[2].src],
    latitude: 37.4361,
    longitude: 127.0162,
    relatedContents: [{ contentId: 5, title: '오징어게임', category: 'DRAMA' }],
  },
  {
    ...
    locationImage: thumbnails[3].src,
    imageUrl: [thumbnails[3].src],
    latitude: 37.3855,
    longitude: 129.2265,
    relatedContents: [{ contentId: 5, title: '오징어게임', category: 'DRAMA' }],
  },
