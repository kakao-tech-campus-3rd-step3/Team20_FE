...
- 이번주의 가장큰 목표는 "서비스의 모든 요소가 동작을 해야 한다" 였습니다.

- **global layout동작 및 not found페이지 구현**: 컴포넌트의 모든 요소가 동작하도록 설정
- **지도페이지 동선 검색 기능 개선**: 사용자 편의를 고려한 UX 향상
- **홈페이지 기능 개선**: 홈페이지 디자인을 개선하고, 최적화 작업
- **컨텐츠 상세 페이지 기능 개선**: 페이지 레이아웃, 이미지 레이아웃 최적화
- **장소 상세페이지 레이아웃, 스타일 개선**: 장소 상세 페이지 스타일 개선
- **Next.js 마이그레이션**: SSR서버 도입 
